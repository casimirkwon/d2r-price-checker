...
const STAT_LABELS = {
  ...
  flatDefense: '방어력+', magicRes: '마법저항%', maxMagicRes: '최대마법저항%', drPct: '피해감소%',
  maxFireDmg: '최대화염피해', minFireDmg: '최소화염피해',
  maxColdDmg: '최대냉기피해', minColdDmg: '최소냉기피해',
  maxLightDmg: '최대번개피해', minLightDmg: '최소번개피해',
  maxPoisonDmg: '최대독피해', minPoisonDmg: '최소독피해',
  flatFireDmg: '화염피해', flatColdDmg: '냉기피해', flatLightDmg: '번개피해', flatMagicDmg: '마법피해',
  amazonSkills: '아마존기술', paladinSkills: '성기사기술', necroSkills: '강령술사기술',
  sorcSkills: '원소술사기술', barbSkills: '야만용사기술', assassinSkills: '암살자기술', druidSkills: '드루이드기술',
  thornsLight: '번개반사피해', kickDmg: '발차기피해', staminaHeal: '지구력회복%',
  drainLife: '생명력흡수', vendorPrices: '상점가격%', selfRepair: '내구도회복', maxDurPct: '최대내구도%',
};
...
const PLACEHOLDER_TO_KEY = {
  ...
  'Damage Reduced by': 'drPct',
  'Amazon Skill Levels': 'amazonSkills',
  'Paladin Skill Levels': 'paladinSkills',
  'Necromancer Skill Levels': 'necroSkills',
  'Sorceress Skill Levels': 'sorcSkills',
  'Barbarian Skill Levels': 'barbSkills',
  'Assassin Skill Levels': 'assassinSkills',
  'Druid Skill Levels': 'druidSkills',
  'Attacker Takes Lightning': 'thornsLight',
  'Kick Damage': 'kickDmg',
  'Heal Stamina': 'staminaHeal',
  'Drain Life': 'drainLife',
  'Reduces Vendor Prices': 'vendorPrices',
  'Repairs Durability': 'selfRepair',
  'Max Durability': 'maxDurPct',
  'Max Fire Damage': 'maxFireDmg',
  'Min Fire Damage': 'minFireDmg',
  'Max Cold Damage': 'maxColdDmg',
  'Min Cold Damage': 'minColdDmg',
  'Max Lightning Damage': 'maxLightDmg',
  'Min Lightning Damage': 'minLightDmg',
  'Max Poison Damage': 'maxPoisonDmg',
  'Min Poison Damage': 'minPoisonDmg',
};
